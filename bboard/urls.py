...
from .views import (
    index, about, user_info, add_addd, 
    edit_addd, delete_addd, search_addd, filter_addd, user_addd, read_addd, update_addd
)
...
urlpatterns = [
    ...
    path('user-info/<int:pk>/', user_info, name='user_info'),
    path('addd/add/', add_addd, name='add_addd'),
    # path('addd/<int:addd_id>/', detail_addd, name='addd_detail'),
    # path('addd/edit/<int:addd_id>/', edit_addd, name='addd_edit'),
